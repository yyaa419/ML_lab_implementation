# AIM: move the data clusters to make it easier/harder for the classfier to make the boudary
import numpy as np
...
classA=q1_data.classA
classB=q1_data.classB
target=q1_data.target
input=q1_data.input
